		...
		<div class="mt-5 mb-5">
			<table class="table">
				...
				<tr>
					...
					<td>
						<a href="delete.php?id=<?= $resP['nisn']?>" onclick="return confirm('Yakin Hapus Data Pendaftar?')" class="btn btn-primary">Batal</a> | 
						<a href="edit.php?id=<?= $resP['nisn']?>" class="btn btn-danger">Edit</a>
					</td>
				</tr>
				<?php endforeach;?>
