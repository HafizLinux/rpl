...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2022 at 12:10 AM
...
CREATE TABLE `nilai` (
  ...
  `matematika` varchar(5) NOT NULL,
  `IPA` varchar(5) NOT NULL,
  `b_inggris` varchar(5) NOT NULL,
  `b_indonesia` varchar(5) NOT NULL
...
INSERT INTO `nilai` (`id_nilai`, `nisn`, `matematika`, `IPA`, `b_inggris`, `b_indonesia`) VALUES
('nl-62e44cd', '10120235', '100', '100', '100', '100');
...
('10120235', 'pn-62e44cd29f773', 'Hafiz Herla Firmansyah', 'Bandung, 15 Agustus 2002', 'Laki-Laki', 'Islam', 'Jl. Bojong ', '0812131293801', 'hafizherla18@gmail.com', 'Hafiz123.', 'SMPN 2 Talegong', 'Pak Haji');
...
CREATE TABLE `skhun` (
  ...
  `no_skhun` varchar(30) DEFAULT NULL,
...
('10120235', '320823901831212', '62e455497add1.png');
